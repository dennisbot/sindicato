...
<html lang="<?php echo $this->config->item('language_attributes') ?>" >
    <head>
        ...
        <title><?php echo ($header_title) ? $header_title . " | " . $this->config->item('site_name') : "Sindicato | " . $this->config->item('site_name') ?></title>
        ...
        <link href="<?php echo bootstrap_css(); ?>bootstrap-responsive.min.css" rel="stylesheet">
        ...
        <link rel="shortcut icon" href="<?php echo base_img(); ?>favicon.png">
