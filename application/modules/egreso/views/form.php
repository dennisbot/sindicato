<div class="padded form-agregar">
    ...
    <form class="form-horizontal" method="post" id="form-egreso" action="<?php echo site_url($this->uri->uri_string()); ?>">
        <div class="control-group <?php echo form_error('concepto') != '' ? 'error' : '';?>">
            <label class="control-label">* Concepto </label>
            <div class="controls">
            <textarea style ="width:300px;"  rows="2" cols="5" name="concepto" id="concepto"><?php echo $this->mdl_egreso->form_value('concepto'); ?></textarea>
            </div>
        </div>
        <div class="control-group <?php echo form_error('importe') != '' ? 'error' : '';?>">
            <label class="control-label">* Importe S/.</label>
            <div class="controls">
                <input class="currency" type="text" name="importe" value="<?php echo $this->mdl_egreso->form_value('importe'); ?>"/>
            </div>
        </div>
        <div class="control-group <?php echo form_error('fecha') != '' ? 'error' : '';?>">
            ...
            <div class="controls">
                ...
                <input name="fecha" type="text" value="<?php echo $fecha;?>" readonly="readonly" placeholder="click para seleccionar">
